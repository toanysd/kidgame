...
export const isLeft = (id) => {
	if (id === 0 && window.AI_FRAME_INPUT && window.AI_FRAME_INPUT.left) return true;
	if (id === 1 && window.AI_OPPONENT_INPUT && window.AI_OPPONENT_INPUT.left) return true;
...
export const isUp = (id) => {
	if (id === 0 && window.AI_FRAME_INPUT && window.AI_FRAME_INPUT.up) return true;
	if (id === 1 && window.AI_OPPONENT_INPUT && window.AI_OPPONENT_INPUT.up) return true;
...
export const isRight = (id) => {
	if (id === 0 && window.AI_FRAME_INPUT && window.AI_FRAME_INPUT.right) return true;
	if (id === 1 && window.AI_OPPONENT_INPUT && window.AI_OPPONENT_INPUT.right) return true;
...
export const isDown = (id) => {
	if (id === 0 && window.AI_FRAME_INPUT && window.AI_FRAME_INPUT.down) return true;
	if (id === 1 && window.AI_OPPONENT_INPUT && window.AI_OPPONENT_INPUT.down) return true;
...
export const isLightPunch = (id, forControlHistory = false) => {
	if (id === 0 && window.AI_FRAME_INPUT && window.AI_FRAME_INPUT.lightPunch) return true;
	if (id === 1 && window.AI_OPPONENT_INPUT && window.AI_OPPONENT_INPUT.lightPunch) return true;
	return isKeyPressed(id, Control.LIGHT_PUNCH, forControlHistory);
};
export const isMediumPunch = (id, forControlHistory = false) => {
	if (id === 0 && window.AI_FRAME_INPUT && window.AI_FRAME_INPUT.mediumPunch) return true;
	if (id === 1 && window.AI_OPPONENT_INPUT && window.AI_OPPONENT_INPUT.mediumPunch) return true;
	return isKeyPressed(id, Control.MEDIUM_PUNCH, forControlHistory);
};
export const isHeavyPunch = (id, forControlHistory = false) => {
	if (id === 0 && window.AI_FRAME_INPUT && window.AI_FRAME_INPUT.heavyPunch) return true;
	if (id === 1 && window.AI_OPPONENT_INPUT && window.AI_OPPONENT_INPUT.heavyPunch) return true;
	return isKeyPressed(id, Control.HEAVY_PUNCH, forControlHistory);
};

export const isLightKick = (id, forControlHistory = false) => {
	if (id === 0 && window.AI_FRAME_INPUT && window.AI_FRAME_INPUT.lightKick) return true;
	if (id === 1 && window.AI_OPPONENT_INPUT && window.AI_OPPONENT_INPUT.lightKick) return true;
	return isKeyPressed(id, Control.LIGHT_KICK, forControlHistory);
};
export const isMediumKick = (id, forControlHistory = false) => {
	if (id === 0 && window.AI_FRAME_INPUT && window.AI_FRAME_INPUT.mediumKick) return true;
	if (id === 1 && window.AI_OPPONENT_INPUT && window.AI_OPPONENT_INPUT.mediumKick) return true;
	return isKeyPressed(id, Control.MEDIUM_KICK, forControlHistory);
};
export const isHeavyKick = (id, forControlHistory = false) => {
	if (id === 0 && window.AI_FRAME_INPUT && window.AI_FRAME_INPUT.heavyKick) return true;
	if (id === 1 && window.AI_OPPONENT_INPUT && window.AI_OPPONENT_INPUT.heavyKick) return true;
